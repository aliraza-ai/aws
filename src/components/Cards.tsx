    ...
    return (
        <div className="text-white p-5 basis-1/3 bg-[rgba(32,45,72,0.41)] overflow-hidden relative backdrop-blur-md shadow rounded-md h-[200px]">
            ...
            <div className='flex items-center gap-1 justify-end text-center'>
                <p className='bg-[#de1df5] text-white font-semibold pb-[1px] pt-1 px-2 md:text-[10px] text-[8px] rounded-full'>New</p>
                <p className='bg-[#011dfd] text-white font-semibold pb-[1px] pt-1 px-2 md:text-[10px] text-[8px] rounded-full'>Live Demo</p>
            </div>
