...
const AboutSection = () => {
  ...
  return (
    <div className="flex flex-wrap w-full">
      <div className="flex lg:flex-row flex-col items-center justify-between w-full container mx-auto gap-8 p-10">
        ...
        <div className="lg:w-1/2 w-full text-left xl:pr-20">
          <h2 className="text-white lg:text-5xl md:text-4xl text-3xl font-normal md:w-4/5">
            Create Images with <br />
            <span className="bg-clip-text text-transparent bg-gradient-to-tr from-[#ec44ff] to-[#2d46ff]">
              Intelliwriter
            </span>
          </h2>
          <p className="py-6 text-white text-lg font-thin md:w-4/5">
