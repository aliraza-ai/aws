export const contentApisData = [
    {
        ...
        endPoint: "https://intelliwriter.io/api/video_description? title=Make Your LinkedIn Profile Work for You: The College Student's Guide",
        details: [
            {
                heading: "API Name",
            ...
            {
                heading: "Description",
                description: 'This API is designed to automatically generate video descriptions based on a provided title. It is a helpful tool for content creators, video editors, and marketers who want to save time and ensure consistent and engaging video descriptions.',
                route: null,
                method: null,
            },
            {
                ...
                bullets: [
                    {
                        paramTitle: 'Title',
                        type: 'string',
                        description: 'The title of the video for which you want to generate a description.'
                    },
                ],
            },
            {
                ...
                bullets: [
                    {
                        ...
                        type: 'string',
                        description: 'The generated video description based on the provided title.'
                    },
                ],
            },
            {
                ...
                bulletStatus: [
                    ...
                    },
                    {
                        ...
                        description: "If the request is missing the 'Title' parameter or if the title is too short.",
                    },
                ],
            },
            {
        ...
        description: "This API simplifies the process of creating engaging video descriptions, making it easier for you to attract and retain viewers with well-crafted descriptions that match your video's content.",
        codeBlock: {
    ...
    },
    {
        ...
        endPoint: "https://intelliwriter.io/api/article? title=Make Your LinkedIn Profile Work for You: The College Student's Guide",
        details: [
            {
                heading: "API Name",
            ...
            {
                heading: "Description",
                description: 'This API is designed to automatically generate articles based on three input parameters: Title, Keywords, and Subheading. It is a valuable tool for content writers, bloggers, and businesses looking to quickly create informative articles.',
                route: null,
                method: null,
            },
            {
            ...
            },
            {
                ...
                bullets: [
                    ...
                    },
                    {
                        paramTitle: 'Keywords',
                        type: 'string',
                        description: 'A list of keywords relevant to the article, separated by commas.'
                    },
                    {
                ...
                bullets: [
                    {
                        paramTitle: 'article',
                        type: 'string',
                        description: 'The generated article based on the provided Title, Keywords, and Subheading.'
                    },
                ],
            },
            {
                ...
                bulletStatus: [
                    ...
                    {
                        status: '400 Bad Request',
                        description: "If the request is missing any of the required parameters.",
                    },
                ],
            },
            {
        ...
        description: "This API streamlines the process of creating informative articles, helping you save time and effort while producing content that aligns with your desired topics and keywords.",
        codeBlock: {
    ...
    },
    {
        ...
        title: "Tags Provider",
        link: 'tags-provider',
        endPoint: "https://intelliwriter.io/api/video_tags?title=Development Tutorials se KUCH NAHI HOGA! | Tanay Pratap Hindi",
        details: [
            {
                heading: "API Name",
            ...
            {
                heading: "Description",
                description: "This API is designed to automatically generate tags for a given title. It's a valuable tool for content creators and video publishers looking to generate relevant tags for their videos based on the video's title.",
                route: null,
                method: null,
            },
            {
                ...
                bullets: [
                    {
                        paramTitle: 'Title',
                        type: 'string',
                        description: 'The title of the video for which you want to generate tags.'
                    },
                ],
            },
            {
        ...
        description: "This API simplifies the process of creating video tags, making it easier for you to optimize your video's metadata and improve its visibility on video platform.",
        codeBlock: {
    ...
    },
    {
        ...
        link: 'title-provider',
        endPoint: "https://intelliwriter.io/api/video_title?description=Are you a college student aiming to get ahead of the competition in the professional world? Look no further! This guide to crafting an impressive LinkedIn profile for 2023 outlines the tips and tricks to help you showcase your skills, achievements, and aspirations. Here’s everything you need to know to make sure your profile is prepped and ready for your dream career.",
        details: [
            {
                heading: "API Name",
            ...
            {
                heading: "Description",
                description: "This API is designed to automatically generate SEO-friendly titles for a given description. It's a valuable tool for content creators and marketers looking to craft attention-grabbing and search engine optimized titles for their content.",
                route: null,
                method: null,
            },
            {
                ...
                bullets: [
                    {
                        paramTitle: 'Description',
                        type: 'string',
                        description: 'The description or content for which you want to generate a SEO-friendly title.'
                    },
                ],
            },
            {
                ...
                bullets: [
                    {
                        paramTitle: 'title',
                        type: 'string',
                        description: 'The generated SEO-friendly title based on the provided description.'
                    },
                ],
            },
            {
                ...
                bulletStatus: [
                    ...
                    {
                        status: '400 Bad Request',
                        description: "If the request is missing the 'Description' parameter or if the description is too short.",
                    },
                ],
            },
            {
    ...
    },
    {
        ...
        endPoint: "https://intelliwriter.io/api/caption?title=How to create a Great LinkedIn Profile in 2023 | for College Students",
        details: [
            {
                heading: "API Name",
            ...
            {
                heading: "Description",
                description: "This API is designed to automatically generate captions or short descriptions for a given title. It's a useful tool for content creators and social media marketers looking to create engaging and concise captions for their posts or content.",
                route: null,
                method: null,
            },
            {
                ...
                bullets: [
                    {
                        paramTitle: 'caption',
                        type: 'string',
                        description: 'The generated caption or short description based on the provided title.'
                    },
                ],
            },
            {
        ...
        description: "This API simplifies the process of creating engaging and concise captions, making it easier for you to captivate your audience and convey the essence of your content effectively.",
        codeBlock: {
    ...
    },
    {
        ...
        endPoint: "https://intelliwriter.io/api/description?title=Make Your LinkedIn Profile Work for You: The College Student's Guide",
        details: [
            {
                heading: "API Name",
            ...
            {
                heading: "Description",
                description: "This API is designed to automatically generate descriptions for a given title. It's a valuable tool for content creators and marketers looking to create informative and engaging descriptions for various content types.",
                route: null,
                method: null,
            },
            {
                ...
                bullets: [
                    {
                        paramTitle: 'Title',
                        type: 'string',
                        description: 'The title or content for which you want to generate a description.'
                    },
                ],
            },
            {
                ...
                bullets: [
                    {
                        paramTitle: 'description',
                        type: 'string',
                        description: 'The generated description based on the provided title.'
                    },
                ],
            },
            {
        ...
        description: "This API simplifies the process of creating informative and engaging descriptions, saving you time and effort while ensuring your content is well-described and enticing to your audience.",
        codeBlock: {
    ...
    },
    {
        ...
        details: [
            ...
            {
                heading: "Description",
                description: "This API is designed to automatically generate relevant hashtags for a given description. It's a valuable tool for social media enthusiasts, content creators, and marketers looking to generate hashtags that align with the content of their descriptions.",
                route: null,
                method: null,
            },
            {
                ...
                bullets: [
                    {
                        paramTitle: 'Description',
                        type: 'string',
                        description: 'The description or content for which you want to generate hashtags.'
                    },
                ],
            },
            {
                ...
                bullets: [
                    {
                        paramTitle: 'hashtags',
                        type: 'string',
                        description: 'The generated hashtags based on the provided description.'
                    },
                ],
            },
            {
        ...
        description: "This API simplifies the process of creating relevant and effective hashtags, helping you improve the visibility of your content and reach a wider audience.",
        codeBlock: {
    ...
    },
    {
        ...
        details: [
            ...
            {
                heading: "Description",
                description: "This API is designed to automatically generate help wanted ads for job postings based on three input parameters: Job Title, Company Name, and Location. It's a useful tool for recruiters and businesses looking to create engaging and informative job ads to attract potential candidates.",
                route: null,
                method: null,
            },
            {
                ...
                bullets: [
                    {
                        ...
                        type: 'string',
                        description: 'The generated help wanted ad based on the provided Job Title, Company Name, and Location.',
                    },
                ],
            },
            {
        ...
        description: "This API simplifies the process of creating compelling job ads, helping you reach and engage with a broader pool of candidates for your job openings.",
        codeBlock: {
    ...
    },
    {
        ...
        details: [
            ...
            {
                heading: "Description",
                description: "This API is designed to automatically generate frequently asked questions (FAQs) based on a provided description and company name. It's a useful tool for businesses, websites, and customer support teams looking to create informative FAQs to assist their customers.",
                route: null,
                method: null,
            },
            {
                ...
                bullets: [
                    {
                        paramTitle: 'Description',
                        type: 'string',
                        description: "A description or content that provides context for generating FAQs",
                    },
                    {
                        paramTitle: 'Company_name',
                        type: 'string',
                        description: "The name of the company or organization related to the FAQs.",
                    },
                ],
            },
            {
                ...
                bullets: [
                    {
                        paramTitle: 'faqs',
                        type: 'string',
                        description: 'The generated FAQs based on the provided description and company name.',
                    },
                ],
            },
            {
                ...
                bulletStatus: [
                    ...
                    {
                        status: '400 Bad Request',
                        description: 'If the request is missing the "Description" or "Company_Name" parameters.',
                    },
                ],
            },
            {
        ...
        description: "This API simplifies the process of creating FAQs, helping you provide valuable information to your audience and improve customer satisfaction.",
        codeBlock: {
    ...
    },
    {
        ...
        details: [
            ...
            {
                heading: "Description",
                description: " This API is designed to automatically generate text-based quizzes based on three input parameters: Subject, Question, and Topic. It's a valuable tool for educators, content creators, and websites looking to create engaging text-based quizzes for their audience.",
                route: null,
                method: null,
            },
            {
            ...
            },
            {
                ...
                bullets: [
                    ...
                    },
                    {
                        paramTitle: 'Topic',
                        type: 'string',
                        description: "A subtopic or additional information related to the quiz",
                    },
                ],
            },
            {
