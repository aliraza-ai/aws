...
import { marketingcontent, curve1, } from '../../../public'
import { FAQs } from '@/components'
import { MarketingGeneratorFAQs } from "@/constants/FaqsData";
import { dataMarketing, MoretoolsMarketing,stepsMarketing} from "@/constants/index";
    ...
    <div className="my-16">
      <div className="text-center text-white flex flex-col items-center justify-between gap-3 my-20">
        ...
        <p className="text-sm md:text-lg my-4 w-[90%] xl:w-[50%]">
          ...
          artistic expression. Whether you're a Digital Marketer,Investor,Product owner or
        ...
        <div className="w-fit">
          <button className="w-fit rounded-lg bg-gradient-to-r from-[rgba(247,15,255,1)] to-[#2C63FF] px-3 py-1 md:px-4 md:py-2 hover:opacity-90">
            <Link href="/auth/register" target="_blank">
              Try Intelliwriter AI Marketing Generator!
            </Link>
          </button>
        </div>
      </div>
      ...
      <div className="container mx-auto">
        <div className="flex flex-wrap gap-4 m-6 justify-center item-center">
          {dataMarketing.map((item, index) => (
            <div key={index} className="card w-FULL md:w-1/3 xl:w-1/5 bg-blue-900 bg-opacity-20 p-2 ml-4">
      ...
      <div className="my-10 md:my-20 text-center text-white flex flex-col items-center justify-center">
        ...
        <p className="text-sm md:text-lg my-4 w-[90%] xl:w-[50%]">
          Intelliwriter's AI Marketing Generator isn't just a tool, it's an experience. We've
      ...
      <div className="imageContentGeneratorSteps text-center py-10 px-[10%] text-white  flex flex-col items-center justify-center ">
        <h2 className="mb-5 text-2xl md:text-5xl font-semibold capitalize  ">
          ...
          {stepsMarketing.map((item) => (
            <div
              key={item.id}
              className={` my-4 py-2 flex flex-col gap-5 md:flex md:flex-row md:items-center md:justify-between w-full ${
        ...
        <div className="container mx-auto">
          <div className="flex flex-wrap justify-center item-center">
            {MoretoolsMarketing.map((item, index) => (
              <div key={index} className="bg-blue-900 m-2 text-center p-2 bg-opacity-20 md:w-[25%] lg:w-[15%] Moretools">
                 <span
