...
const LoginPage = ({ children }: { children: React.ReactNode; }) => {
  return (
    <>
      <head>
        <title>Login to IntelliWriter.io – Access AI-Powered Content Tools</title>
        <meta name="description" content="Log in to your IntelliWriter.io account to start creating exceptional content with AI. Access our advanced writing and image generation tools to revolutionize your content strategy." />
