...
export const metadata: Metadata = {
  title: "IntelliWriter.io – AI Image Caption Generator",
  description:
...
const ImageCaption = ({ children }: { children: React.ReactNode }) => {
  return (
    <>
      <Head>
        <title>
        IntelliWriter.io – AI Image Caption Generator    
        </title>
        <meta
          name="description"
        ...
        />
        <link rel="canonical" href="https://intelliwriter.io/image-caption-generator" />
